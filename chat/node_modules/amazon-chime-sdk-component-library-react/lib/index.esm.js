...
import { ConsoleLogger, LogLevel, DefaultModality, MeetingSessionStatusCode, DefaultDeviceController, DefaultMeetingSession, DefaultActiveSpeakerPolicy, DefaultBrowserBehavior, isAudioTransformDevice, isVideoTransformDevice, BackgroundBlurVideoFrameProcessor, NoOpVideoFrameProcessor, DefaultVideoTransformDevice, VoiceFocusDeviceTransformer, VoiceFocusTransformDevice, BackgroundReplacementVideoFrameProcessor } from 'amazon-chime-sdk-js';
import { v4 } from 'uuid';
...
const WithTooltip = (Component, container_id) => (props) => {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        show &&
            bounds &&
            container &&
            ReactDOM.createPortal(React__default.createElement(StyledTooltip, { position: position, bounds: bounds }, props.tooltipContent || props.label), container),
...
const ContentShareProvider = ({ children }) => {
    ...
    const toggleContentShare = useCallback((sourceId) => __awaiter(void 0, void 0, void 0, function* () {
        if (!audioVideo) {
            return;
        }
