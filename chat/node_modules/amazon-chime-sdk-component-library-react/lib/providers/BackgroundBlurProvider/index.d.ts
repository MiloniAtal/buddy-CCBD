import { BackgroundBlurOptions, BackgroundFilterSpec, DefaultVideoTransformDevice, Device } from 'amazon-chime-sdk-js';
...
declare const BackgroundBlurProvider: FC<Props>;
declare const useBackgroundBlur: () => BackgroundBlurProviderState;
